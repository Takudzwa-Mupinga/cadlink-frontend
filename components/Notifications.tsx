                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start mb-1">
                                        <h4 className={`text-base truncate pr-4 ${!notif.read ? 'font-bold text-cad-text' : 'font-medium text-slate-300'}`}>
                                            {notif.title}
                                    ...
                                    <div className="mt-4 flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        {notif.type === 'message' && (
                                            <button className="text-xs border border-cad-border bg-cad-surface/30 text-cad-text px-4 py-2 rounded-lg font-bold hover:bg-cad-surface/50 transition-colors">Reply</button>
                                        )}
                                        {!notif.read && (
                                            <button 
                                                onClick={() => markAsRead(notif.id)}
                                                className="text-xs text-slate-500 hover:text-cad-text flex items-center gap-1.5 font-medium ml-auto"
                                            >
